...
fun SafeEmailWebView(
    ...
    val document = remember(html, loadRemoteImages, trustedHeaderHtml, trustedFooterHtml) {
        buildSafeEmailDocument(html, loadRemoteImages, trustedHeaderHtml, trustedFooterHtml)
    }
...
internal fun buildSafeEmailDocument(
    ...
    val head = """
        ...
        <style>
          ...
          body { box-sizing:border-box; min-width:0 !important; margin:0 !important; padding:18px !important; padding-bottom:max(24px, env(safe-area-inset-bottom)) !important; color:#222; background:#fff; font:15px/1.6 sans-serif; overflow-wrap:anywhere; }
          *, *::before, *::after { box-sizing:border-box; }
          ...
          .omnimail-message-header { all:initial !important; display:block !important; margin:-18px -18px 0 !important; padding:26px 24px 22px !important; color:#222 !important; background:#fff !important; font-family:sans-serif !important; }
          .omnimail-message-header h1 { all:initial !important; display:block !important; margin:0 0 20px !important; color:#222 !important; font:600 24px/1.28 sans-serif !important; overflow-wrap:anywhere !important; }
          .omnimail-person { all:initial !important; display:flex !important; align-items:flex-start !important; gap:12px !important; }
          .omnimail-avatar { all:initial !important; display:flex !important; flex:0 0 40px !important; width:40px !important; height:40px !important; align-items:center !important; justify-content:center !important; border-radius:50% !important; color:#222 !important; background:#eeeef1 !important; font:600 16px/1 sans-serif !important; }
          .omnimail-person-copy { all:initial !important; display:block !important; min-width:0 !important; flex:1 !important; }
          .omnimail-message-header .omnimail-sender { all:initial !important; display:block !important; color:#222 !important; font:600 16px/1.4 sans-serif !important; }
          .omnimail-message-header .omnimail-meta { all:initial !important; display:block !important; color:#666 !important; font:13px/1.45 sans-serif !important; overflow-wrap:anywhere !important; }
          .omnimail-header-divider { display:block !important; height:1px !important; margin-top:22px !important; background:#d5d5d9 !important; }
          .omnimail-remote-banner { all:initial !important; display:flex !important; align-items:center !important; gap:10px !important; margin:0 -18px 18px !important; padding:12px 20px !important; color:#444 !important; background:#eeeef1 !important; font:13px/1.4 sans-serif !important; }
          .omnimail-shield { display:inline-block !important; flex:0 0 18px !important; width:18px !important; height:21px !important; background:#626268 !important; clip-path:polygon(50% 0, 100% 18%, 88% 70%, 50% 100%, 12% 70%, 0 18%) !important; }
          .omnimail-remote-banner .omnimail-banner-label { flex:1 !important; }
          .omnimail-remote-banner a { color:#222 !important; font-weight:600 !important; text-decoration:none !important; padding:8px 4px !important; }
          .omnimail-plain-text { white-space:pre-wrap !important; color:#222 !important; background:#fff !important; font:16px/1.65 sans-serif !important; }
          .omnimail-attachments { all:initial !important; display:block !important; margin:24px -18px -18px !important; padding:24px !important; color:#222 !important; background:#fff !important; font-family:sans-serif !important; }
          .omnimail-attachments h2 { all:initial !important; display:block !important; margin-bottom:12px !important; color:#222 !important; font:600 18px/1.4 sans-serif !important; }
          .omnimail-attachment { display:flex !important; flex-direction:column !important; gap:3px !important; margin-bottom:8px !important; padding:12px 14px !important; border-radius:12px !important; background:#eeeef1 !important; }
          .omnimail-attachment strong { font:500 15px/1.4 sans-serif !important; overflow-wrap:anywhere !important; }
          .omnimail-attachment span, .omnimail-attachments p { color:#666 !important; font:13px/1.45 sans-serif !important; }
        </style>
    """.trimIndent()
