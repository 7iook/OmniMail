import { AlertCircle, Cloud, LoaderCircle, Mail } from 'lucide-react'
...
export function MailWorkspaceSettings({
  ...
  async function toggle(target: 'icloud' | 'linuxdo') {
    const previous = { iCloudWorkspaceEnabled, linuxDoMailWorkspaceEnabled }
    const next = {
