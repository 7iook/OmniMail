export const enMailWorkspaces: Record<string, string> = {
  '邮箱功能入口': 'Mailbox workspace entries',
  '控制可选邮箱工作区是否显示在导航中':
    'Control whether optional mailbox workspaces appear in navigation',
  'iCloud 隐藏邮箱入口': 'iCloud Hide My Email entry',
  ...
  '入口已隐藏，已保存的 Linux DO 账号不会删除':
    'The entry is hidden; saved Linux DO accounts are not deleted',
  '入口已隐藏，已保存的 Gmail 账号和索引不会删除':
    'The entry is hidden; saved Gmail accounts and indexes are not deleted',
  '入口已隐藏，已保存的 Microsoft 账号和索引不会删除':
  ...
  '关闭开关只会隐藏入口，不会删除账号、凭据或邮件。':
    'Turning an entry off only hides it; accounts, credentials, and messages are not deleted.',
  '无法更新邮箱功能入口。': 'Could not update mailbox workspace entries.',
}
